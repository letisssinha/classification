...
def call_llm_indicators(text, file):
    prompt  = "Retorne uma tabela em csv com todos os medidores de performance citados nesse text, com como eles sao usados no texto (incluindo derivados de medidores que também podem servir como medidores) e evidencias no texto"
    final_prompt = text+"\n"+prompt
...
def error_articles(article):
      with open("/Users/i553815/lerning/classification/AI/AI/notprocessed.txt", "a", newline="", encoding="utf-8") as f:
        if isinstance(article, str):
            f.write(article)
            f.write("\n")

pdf_loop("/Users/i553815/lerning/articles_copy", "/Users/i553815/lerning/classification/AI/AI/indicators.csv")
